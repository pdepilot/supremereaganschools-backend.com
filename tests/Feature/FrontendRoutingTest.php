...
class FrontendRoutingTest extends TestCase
{
    ...
    public function test_public_pages_use_laravel_routes_without_html_extensions(): void
    {
        ...
        $this->get('/nursery')
            ...
            ->assertSee('Learning in the Early Years', false)
            ->assertSee('href="/admissions"', false)
            ->assertSee('href="/contact"', false)
            ->assertSee('href="/branches"', false)
            ...
            ->assertDontSee('A day in the early years', false)
            ->assertDontSee('safe and caring', false)
            ->assertDontSee('safe, caring', false)
            ->assertSee('"@type":"EducationalOrganization"', false);
        ...
        $this->get('/primary')
            ...
            ->assertSee('Nigerian and British curriculum', false)
            ->assertSee('href="/admissions"', false)
            ->assertSee('href="/contact"', false)
            ->assertSee('href="/branches"', false)
            ...
            ->assertDontSee('safe and supportive', false)
            ->assertSee('"@type":"EducationalOrganization"', false);
        ...
        $this->get('/secondary')
            ...
            ->assertDontSee('higher education', false)
            ->assertDontSee('real-world challenges', false)
            ->assertDontSee('WAEC', false)
            ->assertDontSee('NECO', false)
            ->assertDontSee('JSS', false)
            ->assertDontSee('Basic 1', false)
            ->assertSee('"@type":"EducationalOrganization"', false);
