...
class InvoicePolicy
{
    ...
    {
        return $this->access->allows($user, PermissionSlug::FeesView, PermissionSlug::PaymentsView)
    ...
    {
        if ($this->access->allows($user, PermissionSlug::FeesView, PermissionSlug::PaymentsView)) {
            return true;
        }
